			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="row">
						...
						<?php
								if ($this->session->tempdata('delete_notifi') != "") {
								?>
									<div class="alert alert-warning alert-dismissible fade show" role="alert">
										<?= $this->session->tempdata('delete_notifi') ?>
										...
										<tbody>
											...
											foreach ($show as $key) { ?>
												<tr class="odd gradeX">
													...
													<td><a href="<?= base_url('admin/delete-notifi?q=' . $key->id) ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
												</tr>
											<?php } ?>
										</tbody>
									</table>
