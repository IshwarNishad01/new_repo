				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Slider Image List</div>
							</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<?php
							if ($this->session->tempdata('delete_slider') != "") {
							?>
								<div class="alert alert-warning alert-dismissible fade show" role="alert">
									<?= $this->session->tempdata('delete_slider') ?>
							...
							<div class="card-box">
								<div class="card-head">
									<header>Slider Image List</header>
								</div>
								<div class="card-body ">
										...
										<tbody>
											...
											?>
												<tr class="odd gradeX">
													...
													<td><?= $key->date ?></td>
													<td><a href="<?= base_url('admin/delete_slider?id=' . $key->id) ?> "><i class="fa fa-trash" aria-hidden="true"></i></a></td>
												</tr>
											<?php } ?>
										</tbody>
									</table>
