				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Photo List</div>
							</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<?php
							if ($this->session->tempdata('delete_photo') != "") {
							?>
								<div class="alert alert-warning alert-dismissible fade show" role="alert">
									<?= $this->session->tempdata('delete_photo') ?>
										...
										<tbody>
											...
											?>
												<tr class="odd gradeX">
													...
													<td><?= $key->date ?></td>
													<td><a href="<?= base_url('admin/delete_photo?id=' . $key->id) ?> "><i class="fa fa-trash" aria-hidden="true"></i></a></td>
												</tr>
											<?php } ?>
										</tbody>
									</table>
