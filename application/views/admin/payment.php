				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<?php
							if ($this->session->tempdata('active_payment') != "") {
							?>
								<div class="alert alert-warning alert-dismissible fade show" role="alert">
									<?= $this->session->tempdata('active_payment') ?>
											...
											?>
												<tr class="odd gradeX">
													...
													<td>
														<?php
														if($key->status==1){?>
															<a class="btn btn-success" href="<?=base_url()?>active_payment/<?= $key->id?>">Active</a>
															<?php } else { ?>
															<a class="btn btn-danger" href="<?=base_url()?>active_payment/<?= $key->id?>">Deactive</a>
															<?php } ?>
													</td>
												</tr>
											<?php } ?>
