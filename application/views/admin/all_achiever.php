				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Achievers Image List</div>
							</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<?php
							if ($this->session->tempdata('delete_image') != "") {
							?>
								<div class="alert alert-warning alert-dismissible fade show" role="alert">
									<?= $this->session->tempdata('delete_image') ?>
							...
							<div class="card-box">
								<div class="card-head">
									<header>Achievers Image List</header>
								</div>
								<div class="card-body ">
									<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
										<thead>
											...
											<tr>
												<th>S.no. </th> 
												<th> Achievers Name </th>
												<th> Achievers Batch </th>
												<th> Achievers Designation </th>
												<th> Achievers Image </th>
												<th> Upload Date </th>
												<th> Action </th>
											</tr>
										</thead>
										<tbody>
											...
											?>
												<tr class="odd gradeX">
													...
													<td class="batch"><?= $key->batch ?></td>
													<td class="designation"><?= $key->designation ?></td>
													<td class="image"><?= $key->image ?></td>
													<td><?= $key->date ?></td>
													<td><a href="<?= base_url('admin/delete_achiever?id=' . $key->id) ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
												</tr>
											<?php } ?>
										</tbody>
									</table>
