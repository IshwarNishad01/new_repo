				...
				<div class="container">
					<div class="row justify-content-start">
						<div class="col-sm-10 col-lg-8">
							...
							<a href="<?= base_url('about') ?>" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft mt-3">Read More</a>
							<a href="<?= base_url('registration') ?>" class="btn btn-light py-md-3 px-md-5 animated slideInRight mt-3">Join Now</a>
						</div>
					</div>
				</div>
			</div>
...
<!-- Categories Start -->
<div class="container-xxl category mt-5">
	<div class="container">
		<center>
...
<div class="container-xxl py-5 mt-5">
	<div class="container">
		<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
			<h6 class="section-title bg-white text-center text-primary px-3">Achievers</h6>
	...
	<div class="container">
			...
			<div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
				...
				<div class="d-flex align-items-center mb-3">
					...
					<div class="ms-3">
						...
						<p class="mb-0"> Street No. 1, Near Over Gali .-1, Lodhi Para Kapa, Raipur, Chhattisgarh</p>
					</div>
				</div>
				<div class="d-flex align-items-center mb-3">
					<div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
					...
					<div class="ms-3">
						...
						<p class="mb-0">+91 98271 15944 , 77728 44544</p>
					</div>
				</div>
				<div class="d-flex align-items-center">
					...
					<div class="ms-3">
						...
						<p class="mb-0">gayatristenotyping2021@gmail.com</p>
					</div>
				</div>
			</div>
		...
		<div class="row g-4">
			<div class="col-lg-12 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3718.2466707860995!2d81.65474297431298!3d21.26170127973897!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a28dd7b44bc1109%3A0xd4449f0ae8c828b1!2sGayatri%20Typing%20%26%20Steno%20Class!5e0!3m2!1sen!2sin!4v1710403373798!5m2!1sen!2sin" width="100%" height="300" style="min-height: 300px; border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
		</div>
	</div>
</div>
