							...
							<div class="card comp-card">
								<div class="card-body">
									<div class="row align-items-center">
										<div class="col">
											<center>
												<h2 style="margin-top: 10px; margin-bottom: 10px; font-weight: bolder;color: black;height:50px;font-size:30px;">NOTIFICATION</h2></center>
											<div class="col-md-12">
												<div class="single_courses_desc"><hr>
													<?php
							...
							<div class="card comp-card">
								<div class="card-body">
									<div class="row align-items-center">
										<div class="col">
											<center>
												<h2 style="margin-top: 10px; margin-bottom: 10px; font-weight: bolder;color: black;height:50px;font-size:30px;">Student Rgistration Details</h2></center>
											<div class="col-md-12">
											<?php
													foreach($show1 as $row) { ?>
														<div class="title my-3">
															<h5>Student Name: <?= $row->first_name ?></h5>
															<h5>Student DOB: <?= $row->dob ?></h5>
															<h5>Student Identity: <?= $row->identity ?></h5>
															<h5>Student Number: <?= $row->yournumber ?></h5>
															<h5>Student Email: <?= $row->email ?></h5>
															<h5>Student Qualification: <?= $row->qualification ?></h5>
															<h5>Student Temprary Address:<?= $row->temp_address ?></h5>
															<h5>Student Parmanent Address: <?= $row->par_address ?></h5>
															<h5>Date: <?= $row->date ?></h5>
														</div>
													<?php } ?>
											</div>
