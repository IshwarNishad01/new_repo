  ...
  <div class="container-fluid bg-dark text-light footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <script src="assets/fronted_asset/lib/wow/wow.min.js"></script>
    <script src="assets/fronted_asset/lib/easing/easing.min.js"></script>
    <script src="assets/fronted_asset/lib/waypoints/waypoints.min.js"></script>
    <script src="assets/fronted_asset/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Template Javascript -->
    <script src="assets/fronted_asset/js/main.js"></script>
</body>
